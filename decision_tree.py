...
# === Scale only numerical features (excluding 'Image Path') ===
...
joblib.dump(clf_dt, 'decision_tree_classifier.pkl')
joblib.dump(scaler, 'scaler_dt.pkl')  # Use a distinct scaler file name

for col, enc in encoders.items():
    joblib.dump(enc, f'{col.lower().replace(" ", "_")}_encoder.pkl')

print("\nDecision Tree model and encoders saved successfully.")
