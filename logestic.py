...
clf_attack = LogisticRegression(max_iter=500, random_state=42)
...
joblib.dump(clf_attack, 'logistic_regression_classifier.pkl')
joblib.dump(scaler, 'logistic_regression_scaler.pkl')

for col, enc in encoders.items():
    joblib.dump(enc, f'{col.lower().replace(" ", "_")}_encoder.pkl')

print("\nLogistic Regression model and encoders saved successfully.")
